        ...
        <div class="question">
            ...
            <div id="reply" class="minibutton">Ask question</div>
        ...
        <div class="reply">
            <div class="reply__body">
                ...
                <?php  echo do_shortcode('[contact-form-7 id="141" title="Question form"]'); ?>
            </div>
        </div>
        <footer>
            <div class="container">
                    ...
                    <div class="col-lg-3">
                        <div class="footer__logo">
                            <?php  
                                the_custom_logo();
                            ?>    
                            <span class="footer__logo-text">kids world</span>                   
                        </div>
                    </div>
                        ...
                        <div class="footer__contacts">
                            <div class="footer__contacts-item">
                                ...
                                <div class="footer__contacts-tel">
                                    ...
                                    <a href="tel:+327867834358"><?php the_field('phone2', 2); ?></a>
                                </div>
                            </div>
                            <div class="footer__contacts-item">
