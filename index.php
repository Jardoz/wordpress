                        ...
                        ?>
                            ...
                            ?>)">
                                <div class="toys__item-info">
                                    ...
                                    <div class="minibutton toys__trigger">Details</div>
                                </div>
                            </div>
                        <?php
                    }
        ...
        <div class="contacts" id="contacts">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="contacts__descr underlined">
                            We are located in Hasselt, institute premises, second floor.
                            <br> <br>
                            at Kunstlaan 20
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div 
                            ...
                            class="contacts__map">
                            <?php 
                                echo do_shortcode( "[leaflet-map lat=44.66999504497354 lng=-63.61002445220948 zoom=14 zoomcontrol !detect-retina height='340'][leaflet-marker lat=44.67 lng=-63.61]");                               
                            ?>
                        </div>
                    </div>
                </div>
                <div class="row">
                            ...
                            <div class="contacts__phones">
                                <div class="contacts__phoneblock">
                                    ...
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:+327867834347"><?php the_field('phone', 2); ?></a>
                                    </div>
                                </div>
                                <div class="contacts__phoneblock">
                                    Phone №2
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:+327867834358"><?php the_field('phone', 2); ?></a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="title contacts__minititle">Leave a feedback</div>
